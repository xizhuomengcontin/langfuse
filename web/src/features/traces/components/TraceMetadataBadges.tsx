 ...
 * trailing arrow icon. Pills are reserved for tags. Callers branch on the
 * underlying value; these render whenever mounted.
 */
...
export const UserIdBadge = forwardRef<
  HTMLAnchorElement,
  { userId: string; projectId: string } & ReferenceLinkProps
